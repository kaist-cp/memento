...
make -f Makefile_Linked_List ll-recoverable-read ARGS="-DKEY_RANGE=$KEY_RANGE -DINSERTS_PERCENTAGE=0.15 -DDELETES_PERCENTAGE=0.15"
...
make -f Makefile_Linked_List capsules-read ARGS="-DKEY_RANGE=$KEY_RANGE -DINSERTS_PERCENTAGE=0.15 -DDELETES_PERCENTAGE=0.15"

# make -f Makefile_Linked_List ll-recoverable-update ARGS="-DKEY_RANGE=500 -DINSERTS_PERCENTAGE=0.35 -DDELETES_PERCENTAGE=0.35"
make -f Makefile_Linked_List ll-recoverable-update ARGS="-DKEY_RANGE=$KEY_RANGE -DINSERTS_PERCENTAGE=0.35 -DDELETES_PERCENTAGE=0.35"
...
make -f Makefile_Linked_List capsules-update ARGS="-DKEY_RANGE=$KEY_RANGE -DINSERTS_PERCENTAGE=0.35 -DDELETES_PERCENTAGE=0.35"

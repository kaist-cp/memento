...
impl Deferred {
    ...
    pub(crate) fn new<F: FnOnce()>(f: F, key: Option<usize>) -> Self {
...
mod tests {
    ...
    fn string() {
        ...
        let d = Deferred::new(move || assert_eq!(a, "hello"), None);
        d.call();
    }
    ...
    fn boxed_slice_i32() {
        ...
        let d = Deferred::new(move || assert_eq!(*a, [2, 3, 5, 7]), None);
        d.call();
    }
    ...
    fn long_slice_usize() {
        ...
        let d = Deferred::new(move || assert_eq!(a, [2, 3, 5, 7, 11]), None);
        d.call();
    }
}
